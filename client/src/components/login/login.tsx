...
const Login = (props:any)=> {
	...
	const { msg, authenticated, userSignOn} = authContext;
  ...
  return (
      <> 
        <div className="bg-white px-4 md:px-8 flex items-center object-contain bg-cover bg-right min-h-screen relative" style={{backgroundImage: `url(${Background})`}}>
            <div className="container mx-auto flex justify-center items-center">
                <div className="flex lg:flex-row w-full md:w-8/12">
                    ...
                    <form 	className="form__login md:mt-12 lg:w-5/6"
						...
						{
                            alert 
                                ? <MsnForm type="success" msg={alert.msg} />
                                : null
                        }
                        ...
                        <div className="mt-6 md:mt-16  flex justify-between items-end">
							...
							<NavLink className="text-gray-500 underline font-medium" to="register">Register</NavLink>
